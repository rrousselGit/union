...
void main() {
  // 2*String + 1*int + 1*double
  Union3<String, int, double> merge3a =
      Union4<String, String, int, double>.first('').merge3();
  Union3<String, int, double> merge3b =
      Union4<String, int, String, double>.first('').merge3();
  Union3<String, int, double> merge3c =
      Union4<String, int, double, String>.first('').merge3();

  // 1*String + 2*int + 1*double
  Union3<String, int, double> merge3d =
      Union4<String, int, int, double>.first('').merge3();
  Union3<String, int, double> merge3e =
      Union4<String, int, double, int>.first('').merge3();

  // 1*String + 1*int + 2*double
  Union3<String, int, double> merge3f =
      Union4<String, int, double, double>.first('').merge3();

  /// 3*String + 1*int
  Union2<String, int> merge2a =
      Union4<String, String, String, int>.first('').merge2();
  Union2<String, int> merge2b =
      Union4<String, String, int, String>.first('').merge2();
  Union2<String, int> merge2c =
      Union4<String, int, String, String>.first('').merge2();

  /// 2*string + 2*int
  Union2<String, int> merge2d =
      Union4<String, String, int, int>.first('').merge2();
  Union2<String, int> merge2e =
      Union4<String, int, String, int>.first('').merge2();
  Union2<String, int> merge2f =
      Union4<String, int, int, String>.first('').merge2();

  /// 2*String + 3*int
  Union2<String, int> merge2g =
      Union4<String, int, int, int>.first('').merge2();
}
